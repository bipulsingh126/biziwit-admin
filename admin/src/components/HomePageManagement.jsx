      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
          {banners.map((banner, index) => (
            <div key={banner.slug || banner._id} className={`border-2 rounded-xl overflow-hidden transition-all duration-200 ${banner.isActive
              ? 'border-green-200 bg-green-50/30 shadow-sm'
              : 'border-gray-200 bg-gray-50/30'
              }`}>
              {/* Banner Header */}
              <div className={`px-4 py-3 border-b ${banner.isActive ? 'bg-green-100 border-green-200' : 'bg-gray-100 border-gray-200'
                }`}>
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    disabled={saving}
                    className={`p-1.5 rounded-full transition-all duration-200 disabled:opacity-50 ${banner.isActive
